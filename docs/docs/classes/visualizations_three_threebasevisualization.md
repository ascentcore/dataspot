...
* [visualizations.BaseVisualization](/docs/classes/visualizations_basevisualization)
  ...
  ↳↳ [visualizations.three.MeshPlot](/docs/classes/visualizations_three_meshplot)
...
{:.method-highlight}
\+ **new ThreeBaseVisualization**(`config`: any, `elemClass?`: string): [visualizations.three.ThreeBaseVisualization](/docs/classes/visualizations_three_threebasevisualization)
...
**Returns:** [visualizations.three.ThreeBaseVisualization](/docs/classes/visualizations_three_threebasevisualization)
