...
{:.url-source-ref}
[lib/pipeline/types.ts:43](https://github.com/ascentcore/dataspot/blob/c80cb27/lib/pipeline/types.ts#L43)
...
{:.url-source-ref}
[lib/pipeline/types.ts:18](https://github.com/ascentcore/dataspot/blob/c80cb27/lib/pipeline/types.ts#L18)
