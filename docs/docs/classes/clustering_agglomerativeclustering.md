...
{:.url-source-ref}
[lib/clustering/agglomerativeClustering.ts:13](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/agglomerativeClustering.ts#L13)
...
{:.url-source-ref}
[lib/clustering/agglomerativeClustering.ts:11](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/agglomerativeClustering.ts#L11)
...
{:.url-source-ref}
[lib/clustering/clusteringBase.ts:10](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/clusteringBase.ts#L10)
...
{:.url-source-ref}
[lib/clustering/clusteringBase.ts:20](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/clusteringBase.ts#L20)
...
{:.url-source-ref}
[lib/clustering/clusteringBase.ts:15](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/clusteringBase.ts#L15)
...
{:.url-source-ref}
[lib/clustering/agglomerativeClustering.ts:26](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/agglomerativeClustering.ts#L26)
...
{:.url-source-ref}
[lib/clustering/clusteringBase.ts:58](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/clusteringBase.ts#L58)
...
{:.url-source-ref}
[lib/clustering/clusteringBase.ts:41](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/clusteringBase.ts#L41)
...
{:.url-source-ref}
[lib/clustering/agglomerativeClustering.ts:39](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/agglomerativeClustering.ts#L39)

___

{:.method-highlight}
▸ **loadState**(`from`: string \| [clustering.AglomerativeClusteringConfig](../clustering_aglomerativeclusteringconfig)): void

#### Parameters:

Name | Type |
------ | ------ |
`from` | string \| [clustering.AglomerativeClusteringConfig](../clustering_aglomerativeclusteringconfig) |
...
{:.url-source-ref}
[lib/clustering/clusteringBase.ts:72](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/clusteringBase.ts#L72)
...
{:.url-source-ref}
[lib/clustering/agglomerativeClustering.ts:48](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/agglomerativeClustering.ts#L48)
...
{:.url-source-ref}
[lib/clustering/agglomerativeClustering.ts:34](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/agglomerativeClustering.ts#L34)
...
{:.url-source-ref}
[lib/clustering/agglomerativeClustering.ts:30](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/agglomerativeClustering.ts#L30)
...
{:.url-source-ref}
[lib/clustering/agglomerativeClustering.ts:20](https://github.com/ascentcore/dataspot/blob/74b97e8/lib/clustering/agglomerativeClustering.ts#L20)
