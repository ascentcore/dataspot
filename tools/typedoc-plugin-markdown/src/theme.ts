...
export default class MarkdownTheme extends Theme {
    ...
    getNavigation(project: ProjectReflection): NavigationItem {
        const buildNavigationGroups = (navigation: NavigationItem, groups: ReflectionGroup[]) => {
            groups
        ...
        navigation.children?.push(createNavigationItem(hasSeperateGlobals ? 'README' : 'Globals', this.entryFile))
        if (hasSeperateGlobals) {
            navigation.children?.push(createNavigationItem('Globals', this.globalsFile))
        }
